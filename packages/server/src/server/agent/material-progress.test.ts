...
describe("material progress checkpoint", () => {
  ...
  it.each([
    ...
    ["typecheck-zero-warnings", "npm run typecheck", "Found 0 warnings."],
    ["typecheck-zero-mixed", "npm run typecheck", "Found 0 warnings and 0 errors."],
    [
      "typecheck-prose-lookalike",
      "npm run typecheck",
      "The previous report said Found 2 warnings.",
    ],
  ...
  it.each([
    ...
    ["typecheck-warning-only", "npm run typecheck", "Found 2 warnings."],
    ["typecheck-warning-zero-errors", "npm run typecheck", "Found 1 warning and 0 errors."],
    ["typecheck-ansi-warning", "npm run typecheck", "\u001b[33mFound 2 warnings.\u001b[0m"],
    [
      "typecheck-crlf-warning",
      "npm run typecheck",
      "Checking project\r\nFound 2 warnings.\r\nFinished",
    ],
    ["typecheck-cr-warning", "npm run typecheck", "Checking project\rFound 2 warnings.\rFinished"],
