...
export const PASEO_LAUNCH_AGENT_LABEL = "com.timiaji.paseo";
...
function assertManagedExistingLaunchAgent(filePath: string): void {
...
export function reconcilePaseoLaunchAgent(
  ...
  assertManagedExistingLaunchAgent(filePath);
