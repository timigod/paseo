...
| `seenMaterialProgressFingerprints`            | `string[]`                                                                               | Up to 256 exact digests that suppress repeated evidence, oldest first                                                 |
| `seenMaterialProgressFingerprintBloom`        | `string?`                                                                                | Current fixed-size Bloom generation for older digests. Each accepted continuation resets it                           |
| `seenMaterialProgressFingerprintBloomArchive` | `string[]?`                                                                              | Up to three rotated Bloom generations. Saturated or invalid history fails closed until the next accepted continuation |
