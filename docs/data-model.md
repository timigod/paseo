...
| `seenMaterialProgressFingerprintBloom`      | `string?`                                                                                | Fixed-size Bloom filter for older digests. False positives can suppress new progress; each accepted continuation resets it |
